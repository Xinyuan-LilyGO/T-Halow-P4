...
#define RC_FLAGS_ANT_MASK       (0x00 << RC_FLAGS_ANT_SHIFT)
...
#define RC_ANT_GET(grp)         (((0) & RC_FLAGS_ANT_MASK) >> RC_FLAGS_ANT_SHIFT)
#define RC_IDX_CALC(bw, mcs) 	((((bw) << RC_FLAGS_BW_SHIFT) & RC_FLAGS_BW_MASK) + \
                                  (((mcs) << RC_FLAGS_MCS_SHIFT) & RC_FLAGS_MCS_MASK))
#define RC_GRP_CALC(ant, bw, mcs) ((((0) << RC_FLAGS_ANT_SHIFT) & RC_FLAGS_ANT_MASK) + \
