...
Objects1=$(IntermediateDirectory)/common_sysvar$(ObjectSuffix) $(IntermediateDirectory)/common_us_ticker$(ObjectSuffix) $(IntermediateDirectory)/common_dev$(ObjectSuffix) $(IntermediateDirectory)/common_drivercmd$(ObjectSuffix) $(IntermediateDirectory)/common_dsleepdata$(ObjectSuffix) $(IntermediateDirectory)/common_uart_p2p$(ObjectSuffix) $(IntermediateDirectory)/wnb_wnb_dhcpc$(ObjectSuffix) $(IntermediateDirectory)/wnb_ah_freqinfo$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/csky_cpu_impl$(ObjectSuffix) $(IntermediateDirectory)/csky_csky_sched$(ObjectSuffix) $(IntermediateDirectory)/csky_port_c$(ObjectSuffix) $(IntermediateDirectory)/csky_port_s$(ObjectSuffix) 
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	$(LinkerName) $(OutputSwitch) $(IntermediateDirectory)/$(OutputFile)$(ExeSuffix) $(LinkerNameoption) -Wl,--ckmap=$(ProjectPath)/Lst/$(OutputFile).map  @$(ObjectsFileList) $(LibraryPathSwitch)D:/GoogleDownload/AH-V1.6-SDK_20251031144239/AH-V1.6-SDK/hgSDK-v1.6.4.5-38054-fmac/hgSDK-v1.6.4.5-38054-fmac/sdk  -Wl,--whole-archive $(LibrarySwitch)txw4002a   -Wl,--no-whole-archive  $(LinkOptions) $(LibPath) $(Libs) $(LinkOtherFlagsOption)
...
$(IntermediateDirectory)/mac_bus_sdio_bus$(ObjectSuffix): ../sdk/lib/mac_bus/sdio_bus.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mac_bus/sdio_bus.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mac_bus_sdio_bus$(ObjectSuffix) -MF$(IntermediateDirectory)/mac_bus_sdio_bus$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mac_bus_sdio_bus$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mac_bus_sdio_bus$(PreprocessSuffix): ../sdk/lib/mac_bus/sdio_bus.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mac_bus_sdio_bus$(PreprocessSuffix) ../sdk/lib/mac_bus/sdio_bus.c

$(IntermediateDirectory)/mac_bus_usb_bus$(ObjectSuffix): ../sdk/lib/mac_bus/usb_bus.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mac_bus/usb_bus.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mac_bus_usb_bus$(ObjectSuffix) -MF$(IntermediateDirectory)/mac_bus_usb_bus$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mac_bus_usb_bus$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mac_bus_usb_bus$(PreprocessSuffix): ../sdk/lib/mac_bus/usb_bus.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mac_bus_usb_bus$(PreprocessSuffix) ../sdk/lib/mac_bus/usb_bus.c

$(IntermediateDirectory)/mac_bus_uart_bus$(ObjectSuffix): ../sdk/lib/mac_bus/uart_bus.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mac_bus/uart_bus.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mac_bus_uart_bus$(ObjectSuffix) -MF$(IntermediateDirectory)/mac_bus_uart_bus$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mac_bus_uart_bus$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mac_bus_uart_bus$(PreprocessSuffix): ../sdk/lib/mac_bus/uart_bus.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mac_bus_uart_bus$(PreprocessSuffix) ../sdk/lib/mac_bus/uart_bus.c

$(IntermediateDirectory)/mac_bus_usb_device_wifi$(ObjectSuffix): ../sdk/lib/mac_bus/usb_device_wifi.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mac_bus/usb_device_wifi.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mac_bus_usb_device_wifi$(ObjectSuffix) -MF$(IntermediateDirectory)/mac_bus_usb_device_wifi$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mac_bus_usb_device_wifi$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mac_bus_usb_device_wifi$(PreprocessSuffix): ../sdk/lib/mac_bus/usb_device_wifi.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mac_bus_usb_device_wifi$(PreprocessSuffix) ../sdk/lib/mac_bus/usb_device_wifi.c
...
$(IntermediateDirectory)/wnb_wnb_dhcpc$(ObjectSuffix): ../sdk/lib/wnb/wnb_dhcpc.c  
	$(CC) $(SourceSwitch) ../sdk/lib/wnb/wnb_dhcpc.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/wnb_wnb_dhcpc$(ObjectSuffix) -MF$(IntermediateDirectory)/wnb_wnb_dhcpc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/wnb_wnb_dhcpc$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/wnb_wnb_dhcpc$(PreprocessSuffix): ../sdk/lib/wnb/wnb_dhcpc.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/wnb_wnb_dhcpc$(PreprocessSuffix) ../sdk/lib/wnb/wnb_dhcpc.c

$(IntermediateDirectory)/wnb_ah_freqinfo$(ObjectSuffix): ../sdk/lib/wnb/ah_freqinfo.c  
	$(CC) $(SourceSwitch) ../sdk/lib/wnb/ah_freqinfo.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/wnb_ah_freqinfo$(ObjectSuffix) -MF$(IntermediateDirectory)/wnb_ah_freqinfo$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/wnb_ah_freqinfo$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/wnb_ah_freqinfo$(PreprocessSuffix): ../sdk/lib/wnb/ah_freqinfo.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/wnb_ah_freqinfo$(PreprocessSuffix) ../sdk/lib/wnb/ah_freqinfo.c

$(IntermediateDirectory)/wnb_wnb_uart_p2p$(ObjectSuffix): ../sdk/lib/wnb/wnb_uart_p2p.c  
	$(CC) $(SourceSwitch) ../sdk/lib/wnb/wnb_uart_p2p.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/wnb_wnb_uart_p2p$(ObjectSuffix) -MF$(IntermediateDirectory)/wnb_wnb_uart_p2p$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/wnb_wnb_uart_p2p$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/wnb_wnb_uart_p2p$(PreprocessSuffix): ../sdk/lib/wnb/wnb_uart_p2p.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/wnb_wnb_uart_p2p$(PreprocessSuffix) ../sdk/lib/wnb/wnb_uart_p2p.c
...
$(IntermediateDirectory)/mcu_mcu_util$(ObjectSuffix): ../sdk/lib/mcu/mcu_util.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mcu/mcu_util.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mcu_mcu_util$(ObjectSuffix) -MF$(IntermediateDirectory)/mcu_mcu_util$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mcu_mcu_util$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mcu_mcu_util$(PreprocessSuffix): ../sdk/lib/mcu/mcu_util.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mcu_mcu_util$(PreprocessSuffix) ../sdk/lib/mcu/mcu_util.c

$(IntermediateDirectory)/mcu_cw2015$(ObjectSuffix): ../sdk/lib/mcu/cw2015.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mcu/cw2015.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mcu_cw2015$(ObjectSuffix) -MF$(IntermediateDirectory)/mcu_cw2015$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mcu_cw2015$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mcu_cw2015$(PreprocessSuffix): ../sdk/lib/mcu/cw2015.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mcu_cw2015$(PreprocessSuffix) ../sdk/lib/mcu/cw2015.c

$(IntermediateDirectory)/mcu_p824m$(ObjectSuffix): ../sdk/lib/mcu/p824m.c  
	$(CC) $(SourceSwitch) ../sdk/lib/mcu/p824m.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/mcu_p824m$(ObjectSuffix) -MF$(IntermediateDirectory)/mcu_p824m$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/mcu_p824m$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/mcu_p824m$(PreprocessSuffix): ../sdk/lib/mcu/p824m.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/mcu_p824m$(PreprocessSuffix) ../sdk/lib/mcu/p824m.c
