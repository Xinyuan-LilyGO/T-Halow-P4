...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	$(LinkerName) $(OutputSwitch) $(IntermediateDirectory)/$(OutputFile)$(ExeSuffix) $(LinkerNameoption) -Wl,--ckmap=$(ProjectPath)/Lst/$(OutputFile).map  @$(ObjectsFileList) $(LibraryPathSwitch)D:/dgx/code/0_lilygo/T-Halow-P4-V0.2/AH-V1.6-SDK/hgSDK-v1.6.4.3-38054-wnb/hgSDK-v1.6.4.3-38054-wnb/sdk  -Wl,--whole-archive $(LibrarySwitch)txw4002a   -Wl,--no-whole-archive  $(LinkOptions) $(LibPath) $(Libs) $(LinkOtherFlagsOption)
