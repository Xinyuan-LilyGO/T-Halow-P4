...
#define APP_NAME                "2048 Game"

Game2048::Game2048(bool use_status_bar, bool use_navigation_bar):
    ESP_Brookesia_PhoneApp(
        ESP_BROOKESIA_CORE_APP_DATA_DEFAULT(APP_NAME, &img_app_2048, true),
...
bool Game2048::run(void)
{
    ...
    // Position
    lv_obj_align(cur, LV_ALIGN_TOP_RIGHT, -60, 130);
    // Shape
    ...
    // Position
    lv_obj_align(background_grid, LV_ALIGN_CENTER, 0, 0);
    // Shape
    ...
    // Position
    lv_obj_align(_foreground_grid, LV_ALIGN_CENTER, 0, 0);
    // Shape
