...
constexpr ESP_Brookesia_RecentsScreenSnapshotData_t ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()
{
    return {
        .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(260, 420),
        .title = {
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(260, 60),
        ...
        .image = {
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(260, 360),
            .radius = 22,
        },
    };
}

constexpr ESP_Brookesia_RecentsScreenData_t ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_DATA()
{
    return {
        .main = {
