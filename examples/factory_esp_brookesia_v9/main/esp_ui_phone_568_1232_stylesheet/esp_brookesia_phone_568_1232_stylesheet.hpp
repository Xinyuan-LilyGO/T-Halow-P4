...
/* Home */
constexpr ESP_Brookesia_PhoneHomeData_t ESP_BROOKESIA_PHONE_568_1232_DARK_HOME_DATA()
{
    return {
        .status_bar = {
...
/* Manager */
constexpr ESP_Brookesia_PhoneManagerData_t ESP_BROOKESIA_PHONE_568_1232_DARK_MANAGER_DATA()
{
    return {
...
/* Phone */
constexpr ESP_Brookesia_PhoneStylesheet_t ESP_BROOKESIA_PHONE_568_1232_DARK_STYLESHEET()
{
    return {
